...
export class TrackService extends DataService {
    ...
    getTopTracks(limit: number, page: number): Promise<Array<Object>> {
        let url = this.urlBase + '?method=chart.gettoptracks&limit=' + limit + '&page=' + page + '&api_key=' + this.apikey + '&format=json';
